...
class AdvertisingService {
  private bonjourInstance: bonjour.Bonjour | null = null;
  private ssdpServer: SsdpServer | null = null;
  private httpServer: http.Server | null = null;
  private isRunning = false;
  private playbackState: any = {};
  ...
  private handleDialXml(req: http.IncomingMessage, res: http.ServerResponse) {
    const dialXml = `
      <?xml version="1.0"?>
  ...
  private handleDialApp(req: http.IncomingMessage, res: http.ServerResponse) {
    if (req.method === 'POST') {
